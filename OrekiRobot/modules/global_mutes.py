...
import OrekiRobot.modules.sql.global_mutes_sql as sql
from OrekiRobot import OREKI_MOD, OWNER_ID, DEV_USERS, DRAGONS, DEMONS, TIGERS, STRICT_GMUTE
from OrekiRobot.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from OrekiRobot.modules.sql.users_sql import get_all_chats
...
OREKI_MOD.add_handler(GMUTE_HANDLER)
OREKI_MOD.add_handler(UNGMUTE_HANDLER)
OREKI_MOD.add_handler(GMUTE_LIST)
OREKI_MOD.add_handler(GMUTE_STATUS)

if STRICT_GMUTE:
    OREKI_MOD.add_handler(GMUTE_ENFORCER, GMUTE_ENFORCE_GROUP)

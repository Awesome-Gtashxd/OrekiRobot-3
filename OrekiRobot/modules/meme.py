...
OREKI_MOD.add_handler(WEEBIFY_HANDLER)
OREKI_MOD.add_handler(SHOUT_HANDLER)
OREKI_MOD.add_handler(SANITIZE_HANDLER)
OREKI_MOD.add_handler(RUNS_HANDLER)
OREKI_MOD.add_handler(SLAP_HANDLER)
OREKI_MOD.add_handler(PAT_HANDLER)
OREKI_MOD.add_handler(ROLL_HANDLER)
OREKI_MOD.add_handler(TOSS_HANDLER)
OREKI_MOD.add_handler(SHRUG_HANDLER)
OREKI_MOD.add_handler(BLUETEXT_HANDLER)
OREKI_MOD.add_handler(RLG_HANDLER)
OREKI_MOD.add_handler(DECIDE_HANDLER)
OREKI_MOD.add_handler(EIGHTBALL_HANDLER)
OREKI_MOD.add_handler(TABLE_HANDLER)
OREKI_MOD.add_handler(GDMORNING_HANDLER)
OREKI_MOD.add_handler(GDNIGHT_HANDLER)

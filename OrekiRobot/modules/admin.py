...
from OrekiRobot import DRAGONS, OREKI_MOD
...
from OrekiRobot.modules.helper_funcs.extraction import extract_user, extract_user_and_text
...
async def middemote(dmod):
    ...
    if not await is_register_admin(dmod.input_chat, user.id):
        await dmod.reply("**Heyyy, i cant demote non-admin**")
        return
    if not user:
        return
...
OREKI_MOD.add_handler(SET_DESC_HANDLER)
OREKI_MOD.add_handler(SET_STICKER_HANDLER)
OREKI_MOD.add_handler(SETCHATPIC_HANDLER)
OREKI_MOD.add_handler(RMCHATPIC_HANDLER)
OREKI_MOD.add_handler(SETCHAT_TITLE_HANDLER)
OREKI_MOD.add_handler(ADMINLIST_HANDLER)
OREKI_MOD.add_handler(PIN_HANDLER)
OREKI_MOD.add_handler(UNPIN_HANDLER)
OREKI_MOD.add_handler(PINNED_HANDLER)
OREKI_MOD.add_handler(INVITE_HANDLER)
OREKI_MOD.add_handler(PROMOTE_HANDLER)
OREKI_MOD.add_handler(FULLPROMOTE_HANDLER)
OREKI_MOD.add_handler(LOW_PROMOTE_HANDLER)
OREKI_MOD.add_handler(MID_PROMOTE_HANDLER)
OREKI_MOD.add_handler(DEMOTE_HANDLER)
OREKI_MOD.add_handler(SET_TITLE_HANDLER)
OREKI_MOD.add_handler(ADMIN_REFRESH_HANDLER)

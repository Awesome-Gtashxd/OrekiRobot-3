...
def ungban(update: Update, context: CallbackContext):
    ...
    message.reply_text(f"I'll give {user_chat.first_name} a second chance...")
...
OREKI_MOD.add_handler(GBAN_HANDLER)
OREKI_MOD.add_handler(UNGBAN_HANDLER)
OREKI_MOD.add_handler(GBAN_LIST)
OREKI_MOD.add_handler(GBAN_STATUS)

__mod_name__ = "Anti-Spam"
__handlers__ = [GBAN_HANDLER, UNGBAN_HANDLER, GBAN_LIST, GBAN_STATUS]

if STRICT_GBAN:  # enforce GBANS if this is set
    OREKI_MOD.add_handler(GBAN_ENFORCER, GBAN_ENFORCE_GROUP)

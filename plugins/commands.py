...
async def start(c, m):
    ...
    owner_username = owner.username if owner.username else 'awesome_gtashxd'

    text = f"""Hey! {m.from_user.mention(style='md')},

**I am OrekiRobot with Stylish Fonts✍️**

`I can help you to get stylish fonts. Just send me some text and see magic.`

**Bot was Maintained by :** ❤️ ▷ [@Awesome_Gtashxd](https://t.me/Awesome_Gtashxd)
"""

    buttons = [
        [
            InlineKeyboardButton('Support 🚑', url=f"https://t.me/iZaute/5"),
            InlineKeyboardButton('Updates 📢', url=f"https://t.me/iZaute/6")
            ],[
            InlineKeyboardButton('Owner 🖤', url=f"https://t.me/{owner_username}"),
            InlineKeyboardButton('Co-Owner 🖤', url=f"https://t.me/Otazuki004"),
            InlineKeyboardButton('GitHub 🎗', url=f"https://github.com/Awesome-Gtashxd")
            ],[
            InlineKeyboardButton('YouTube ⚡', url=f"https://youtube.com/@Gtash_Universe")
        ]
    ]
    await m.reply_text(
        text=text,
